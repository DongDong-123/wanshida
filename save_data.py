...
class SaveFile:
    def __init__(self):
        ...
        self.t_stan_survey_info1 = t_stan_survey_info1
        self.t_stan_survey_info2 = t_stan_survey_info2
