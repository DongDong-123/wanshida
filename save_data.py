...
t_stan_org = [
    'csnm', 'custormer_name','custormer_ename', 'custormer_sename', 'busi_name', 'appli_country', 'sub_company', 'former_name', 'cert_tp', 'cert_tp_explain', 'cert_num', 'cert_validity', 'state', 'city', 'address', 'post_code', 'tel', 'fax', 'pr_mr_ms', 'pr_name', 'pr_title', 'pr_phone', 'pr_fax', 'pr_email', 'sec_mr_ms', 'sec_name', 'sec_title', 'sec_phone', 'sec_fax', 'sec_email', 'sec_address', 'aml_mr_ms', 'aml_name', 'aml_title', 'aml_phone', 'aml_fax', 'aml_email', 'client_tp', 'lfa_type', 'found_date', 'assets_size', 'country', 'other_oper_country', 'desc_business', 'busi_type', 'industry_type', 'legal_p_name', 'legal_p_ename', 'legal_p_cert_tp', 'legal_p_cert_explain', 'legal_p_cert_num', 'legal_cert_validity', 'registered_capital', 'registered_capital_currency', 'business_scope','establish_busi_date', 'end_busi_date', 'unit_code', 'stat_flag_ori', 'stat_flag', 'mer_unit', 'account_manager', 'create_time', 'update_time', 'creator', 'updator'
]
t_stan_relation = [
